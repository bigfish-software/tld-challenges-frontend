        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <a 
                  href="https://github.com/bigfish-software" 
                  target="_blank"
              ...
              <li>
                <a 
                  href="https://twitch.tv/bigfishsoftware" 
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center space-x-2 text-slate-600 dark:text-slate-400 hover:text-primary-600 dark:hover:text-primary-400 transition-colors"
                >
                  ...
                  <span>BigFish Twitch</span>
                </a>
              </li>
              <li>
                <a 
                  href="https://twitch.tv/chefmaria" 
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center space-x-2 text-slate-600 dark:text-slate-400 hover:text-primary-600 dark:hover:text-primary-400 transition-colors"
                >
                  ...
                  <span>ChefMaria Twitch</span>
                </a>
              </li>
              <li>
                <a 
                  href="https://github.com/bigfish-software/bigfish-mods" 
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center space-x-2 text-slate-600 dark:text-slate-400 hover:text-primary-600 dark:hover:text-primary-400 transition-colors"
                >
