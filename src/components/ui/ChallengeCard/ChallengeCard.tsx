...
export const ChallengeCard = ({
  ...
  // Compact variant - should look exactly like mobile list variant
  if (variant === 'compact') {
    return (
      <div className={`
        group
      ...
      `}>
        ...
        <div className="p-6">
          ...
          {/* Custom Code section and View Details button - mobile layout always */}
          <div className="flex flex-col gap-4 mt-6 mb-6">
            {/* Custom Code section */}
            {custom_code && (
              <div className="flex justify-start">
                <div className="bg-surface border border-default rounded-lg p-4 w-full">
                  <div className="flex items-center justify-between mb-3">
                    <span className="text-xs font-medium text-secondary uppercase tracking-wide">
                      Custom Code
                    </span>
            ...
            {/* Action Buttons - mobile layout (full width) */}
